...
addWord("liang3", "numbers", "两", "liǎng", "Два", "numeral", { note: "Используется только для указания количества" });
...
addWord("ci4", "numbers", "次", "cì", "Раз", "noun");
...
addWord("fen3se4", "colors", "粉红色", "fěn hóng sè", "Розовый цвет", ["adjective", "noun"]);
...
addWord("ting3de", "adjectives", "挺的", "tǐng de", "Очень", "adverb", { note: "Что-то среднее между 很 и 非常" });
addWord("tai4le", "adjectives", "太了", "tài le", "Слишком", "adverb");
...
addWord("gao1zhong2sheng1", "school", "高中生", "gāo zhōng shēng", "Ученик старшей школы", "noun");
...
addWord("fu4xi", "school", "复习", "fù xí", ["Повторять", "Запоминать"], "verb");
...
addWord("shu1fu2", "health", "舒服", "shū fú", ["Комфортный", "Приятный"], "adjective");
...
addWord("luo4bo", "fruits_and_vegetables", "萝卜", "luó bo", "Редиска", "noun");
...
addWord("cha2", "drinks", "茶", "chá", "Чай", "noun");
...
addWord("xiong1di4", "family", "弟们", "xiōng dì", "Братья", "noun");
...
addWord("xian1sheng", "family", "先生", "xiān sheng", "Мужчина", "noun");
addWord("yi4ma1", "family", "姨妈", "yí mā", "Тётя со стороны мамы", "noun");
...
addWord("shu3_2", "personal_info", "属", "shǔ", "Родиться", "verb", { note: "Используется для обозначения знака зодиака" });
//todo аккаунт
addWord("mi4ma3", "personal_info", "密码", "mì mǎ", "Пароль", "noun");

addWord("qi3chuang1", "schedule", "起床", "qǐ chuáng", "Вставать с кровати", "verb");
...
addWord("deshi2hou4", "time", "的时候", "de shí hòu", ["В то время как", "Пока", "Когда", "Параллельно"], "conjunction", { note: "Является грамматической конструкцией, наиболее схожей с союзом \"когда\"" });
...
addWord("you2yung3", "sport", "游泳", "yóu yǒng", "Плавать", "verb");
...
addWord("ci2zi", "books", "词子", "cí zi", "Слово", "noun");
...
addWord("qian2mian", "location", "前面", "qián miàn", ["Перед", "Спереди"], ["adverb", "preposition"]);
addWord("hou4mian", "location", "后面", "hòu miàn", ["Зад", "Сзади"], ["adverb", "preposition"]);
addWord("fu4jin4", "location", "附近", "fù jìn", "Рядом", ["adverb", "preposition"]);
addWord("zuo3", "location", "左", "zuǒ", ["Лево", "Слева"], ["noun", "adjective", "adjective"]);
addWord("you4_1", "location", "右", "yòu", ["Право", "Справа"], ["noun", "adjective", "adjective"]);
...
addWord("dong3", "summarize", "懂", "dǒng", "Понимать", "particle");
addWord("wan2", "summarize", "完", "wán", "Закончить", "particle");
...
addWord("dou1", "summarize", "都", "dōu", "Все", "pronoun", { note: "Выбирает все объекты из множества" });
