...
addWord("liu4_1", "numbers", "六", "liù", "Шесть");
...
addWord("kai1shi3", "verbs", "开始", "kāi shǐ", "Начинать");
...
addWord("jin4_1", "verbs", "进", "jìn", "Входить");
...
addWord("ku1", "verbs", "哭", "kū", "Плакать");
...
addWord("kai1", "verbs", "开", "kāi", "Открывать");
addWord("guan1", "verbs", "关", "guān", "Закрывать");
addWord("xuan3", "verbs", "选", "xuǎn", "Выбирать");
addWord("chang2_1", "verbs", "尝", "cháng", "Пробовать");
addWord("fen1xiang3", "verbs", "分享", "fēn xiǎng", "Делиться");
addWord("qie4", "verbs", "切", "qiè", ["Резать", "Нарезать"]);
addWord("xi2guan4", "verbs", "习惯", "xí guàn", ["Привыкнуть", "Привыкать"]);
addWord("chu1lai2", "verbs", "出来", "chū lái", "Выходить");
addWord("zou3", "verbs", "走", "zǒu", ["Уйти", "Уходить"]);
addWord("ao2ye4", "verbs", "熬夜", "áo yè", ["Засиживаться допоздна", "Не спать"]);

addWord("xiao3", "adjectives", "小", "xiǎo", "Маленький");
addWord("da4", "adjectives", "大", "dà", "Большой");
addWord("duan3", "adjectives", "短", "duǎn", "Короткий");
addWord("chang2_2", "adjectives", "长", "cháng", "Длинный");
addWord("kuai4_1", "adjectives", "快", "kuài", "Быстрый");
addWord("man4", "adjectives", "慢", "màn", "Медленный");
addWord("duo1", "adjectives", "多", "duō", "Много");
addWord("shao3", "adjectives", "少", "shǎo", "Мало");
addWord("zui4", "adjectives", "最", "zuì", "Самый");
addWord("bi3jiao4", "adjectives", "比较", "bǐ jiào", ["Сравнительно", "Более"]);
...
addWord("wan2mei3", "adjectives", "完美", "wán měi", "Идеальный");
...
addWord("wei1xian3", "adjectives", "危险", "wēi xiǎn", "Опасный");
addWord("jian3dan1", "adjectives", "简单", "jiǎn dān", "Простой");
addWord("nan2", "adjectives", "难", "nán", ["Сложно", "Сложный"]);
addWord("yi1yang4", "adjectives", "一样", "yī yàng", ["Одинаковый", "Такой же", "Похожий"]);
...
addWord("hao3jiu3bu4jian4", "talking", "好久不见", "hǎo jiǔ bù jiàn", "Давно не виделись");
addWord("dui4bu4qi3", "talking", "对不起", "duì bù qǐ", "Извините");
addWord("bao4qian4", "talking", "抱歉", "bào qiàn", "Извините");
...
addWord("li4zi", "talking", "例子", "lì zi", ["Пример", "Случай"]);
addWord("ai1ya1", "talking", "哎呀", "āi yā", ["Ай-ай", "Ой"]);

addWord("xue2xiao4", "school", "学校", "xué xiào", "Школа");
addWord("da4xue2", "school", "大学", "dà xué", "Университет");
addWord("yan2jiu1sheng1", "school", "研究生", "yán jiū shēng", "Аспирантура");
addWord("shang4xue2", "school", "上学", "shàng xué", "Ходить в школу");
addWord("xue2xi2", "school", "学习", "xué xí", "Учиться");
addWord("fang4xue2", "school", "放学", "fàng xué", "Заканчивать занятия");
addWord("fang4jia3", "school", "放假", "fàng jiǎ", ["Каникулы", "Отпуск"]);
...
addWord("ke4", "school", "课", "kè", ["Урок", "Занятие"]);
...
addWord("mei3shu4", "school", "美术", "měi shù", ["ИЗО", "Рисование"]);
addWord("ti3yu4", "school", "体育", "tǐ yù", "Физкультура");
addWord("yin1yue4ke4", "school", "音乐课", "yīn yuè kè", "Урок музыки");
...
addWord("mei3shu4shi4", "school", "美术室", "měi shù shì", ["Кабинет ИЗО", "Кабинет рисования"]);
...
addWord("kao3", "school", "考", "kǎo", "Сдавать");
addWord("kao3shi4", "school", "考试", "kǎo shì", "Экзамен");
addWord("tong1guo4", "school", "通过", "tōng guò", "Сдать экзамен");
addWord("ti2", "school", "题", "tí", ["Вопрос", "Задача"]);
addWord("jiao4_2", "school", "教", "jiào", ["Преподавать", "Учить"]);
addWord("fu4xi", "school", "复习", "fù xí", ["Повторять", "Запоминать"]);
addWord("nian4", "school", "念", "niàn", ["Обучаться", "Учиться"]);

addWord("huo2dong4", "events", "活动", "huó dòng", "Мероприятие");
addWord("wan3hui4", "events", "晚会", "wǎn huì", "Вечеринка");
addWord("can1jia1", "events", "参加", "cān jiā", ["Участвовать", "Принимать участие"]);
addWord("jia1ru4", "events", "加入", "jiā rù", "Присоединиться");
addWord("ju3xing2", "events", "举行", "jǔ xíng", ["Проводить", "Устраивать"]);
addWord("xiang3shou4", "events", "享受", "xiǎng shòu", "Наслаждаться");
addWord("biao3yan3", "events", "表演", "biǎo yǎn", "Выступать");
addWord("yan3chu1", "events", "演出", "yǎn chū", "Выступление");
addWord("wu3tai2", "events", "舞台", "wǔ tái", ["Сцена", "Арена"]);
addWord("zhan4tai2", "events", "站台", "zhàn tái", "Платформа");
addWord("yin1yue4", "events", "音乐", "yīn yuè", "Музыка");
addWord("yao2gun3yin1yue4", "events", "摇滚音乐", "yáo gǔn yīn yuè", "Рок музыка");
addWord("yin1yue4jie2", "events", "音乐节", "yīn yuè jié", "Музыкальный фестиваль");
addWord("yue4dui4", "events", "乐队", "yuè duì", "Музыкальная группа");
addWord("yue4qi4", "events", "乐器", "yuè qì", "Музыкальные инструменты");
addWord("ge1", "events", "歌", "gē", "Песня");
addWord("sheng1yin1", "events", "声音", "shēng yīn", "Звук");
addWord("piao4", "events", "票", "piào", "Билет");
addWord("gu3zhang3", "events", "鼓掌", "gǔ zhǎng", "Аплодировать");
addWord("qi4fen1", "events", "气氛", "qì fēn", "Атмосфера");
...
addWord("chuan1", "clothes", "穿", "chuān", ["Надевать", "Носить"]);
addWord("yi1fu2", "clothes", "衣服", "yī fú", "Одежда");
addWord("dai4_2", "clothes", "戴", "dài", ["Надевать аксессуары", "Носить аксессуары"]);
...
addWord("shou3biao3", "clothes", "手表", "shǒu biǎo", "Наручные часы");
addWord("pai2zi", "clothes", "牌子", "pái zi", ["Бренд", "Марка"]);
...
addWord("shi2shang4", "appearance", "时尚", "shí shàng", "Модный");
addWord("ke3pa4", "appearance", "可怕", "kě pà", "Страшный");
addWord("kun4", "appearance", "困", "kùn", "Сонный");
addWord("lei3", "appearance", "累", "lěi", "Уставший");
addWord("xiang4", "appearance", "像", "xiàng", "Быть похожим");

addWord("shen1ti3", "health", "身体", "shēn tǐ", ["Тело", "Здоровье"]);
addWord("jian4kang1", "health", "健康", "jiàn kāng", "Здоровый");
...
addWord("liu4_2", "animals", "遛", "liù", "Выгуливать");

addWord("chi1", "food", "吃", "chī", ["Есть", "Кушать"]);
addWord("fan4", "food", "饭", "fàn", "Еда");
addWord("cai4pu3", "food", "菜谱", "cài pǔ", "Рецепт");
...
addWord("xian2", "food", "咸", "xián", "Солёный");
...
addWord("tang2", "food", "糖", "táng", "Сахар");
...
addWord("you2", "food", "油", "yóu", "Масло");
addWord("nai3you2", "food", "奶油", "nǎi yóu", ["Сливочное масло", "Сливки", "Крем"]);
addWord("jiang4you2", "food", "酱油", "jiàng yóu", "Соевый соус");
addWord("ye4xiao1", "food", "夜宵", "yè xiāo", "Ночной перекус");
addWord("ke4_1", "food", "克", "kè", "Грамм");
addWord("jin1", "food", "斤", "jīn", ["Полкило", "Полкилограмма"]);
addWord("shao2", "food", "勺", "sháo", "Ложка");
addWord("guo1", "food", "锅", "guō", "Кастрюля");
addWord("wan3", "food", "碗", "wǎn", ["Миска", "Тарелка", "Посуда"]);
addWord("zhu3", "food", "煮", "zhǔ", "Варить");
addWord("chao3", "food", "炒", "chǎo", "Жарить");
addWord("guo4qi1", "food", "过期", "guò qī", ["Просрочить", "Просрочиться"]);
...
addWord("da4suan4", "fruits_and_vegetables", "大蒜", "dà suàn", "Чеснок");
...
addWord("sheng1cai4", "fruits_and_vegetables", "生菜", "shēng cài", "Салатные листья");
addWord("bai2cai4", "fruits_and_vegetables", "白菜", "bái cài", "Китайская капуста");
addWord("hu2jiao1fen3", "fruits_and_vegetables", "胡椒粉", "hú jiāo fěn", "Перец");
...
addWord("ke3", "drinks", "渴", "kě", ["Испытывать жажду", "Хотеть пить"]);
...
addWord("ping2zi", "drinks", "瓶子", "píng zi", "Бутылка");
...
addWord("ru4kou3", "interior", "入口", "rù kǒu", "Вход");
addWord("chu1kou3", "interior", "出口", "chū kǒu", "Выход");
...
addWord("sheng1huo2", "family", "生活", "shēng huó", "Жизнь");
addWord("sheng1", "family", "生", "shēng", ["Рожать", "Родить"]);
addWord("jie2hun1", "family", "结婚", "jié hūn", ["Вступить в брак", "Жениться", "Выйти замуж"]);
addWord("ban1jia1", "family", "搬家", "bān jiā", ["Переезжать", "Переезд"]);
...
//todo аккаунт
addWord("mi4ma3", "personal_info", "密码", "mì mǎ", "Пароль");
...
addWord("fen1zhong1", "time", "分钟", "fēn zhōng", "Минута");
addWord("ke4_2", "time", "刻", "kè", ["15 минут", "Четверть часа"]);
addWord("ban4", "time", "半", "bàn", ["30 минут", "Полчаса", "Половина"]);
...
addWord("jin1zao3", "time", "今早", "jīn zǎo", ["Сегодня утром", "Этим утром"]);
...
addWord("zai4_2", "time", "再", "zài", ["Опять", "Снова"]);
addWord("yi3hou4", "time", "以后", "yǐ hòu", "После");
addWord("yi3jing1", "time", "已经", "yǐ jīng", "Уже");
addWord("gang1gang1", "time", "刚刚", "gāng gāng", "Только что");
addWord("gang1cai2", "time", "刚才", "gāng cái", "Только что");
addWord("ye3xu3", "time", "也许", "yě xǔ", "Возможно");
addWord("zhong1yu2", "time", "终于", "zhōng yú", "Наконец");
addWord("dang1shi2", "time", "当时", "dāng shí", ["Тогда", "В тот момент"]);
addWord("zhe4ji3nian2", "time", "这几年", "zhè jǐ nián", "В последние годы");
addWord("deshi2hou4", "time", "的时候", "de shí hòu", ["В то время как", "Пока", "Когда", "Параллельно"]);
...
addWord("jiao1tong1", "transport", "交通", "jiāo tōng", "Транспорт");
addWord("qi2", "transport", "骑", "qí", "Кататься");
addWord("ting2", "transport", "停", "tíng", "Останавливать");
addWord("lu4", "transport", "路", "lù", ["Улица", "Дорога"]);
addWord("du3che1", "transport", "堵车", "dǔ chē", ["Пробка", "Иметь пробки"]);
...
addWord("gong1jiao1zhan4", "transport", "公交站", "gōng jiāo zhàn", "Автобусная остановка");
addWord("huo3che1", "transport", "火车", "huǒ chē", "Поезд");
addWord("huo3che1zhan4", "transport", "火车站", "huǒ chē zhàn", "Железнодорожный вокзал");
addWord("lou2ti1", "transport", "楼梯", "lóu tī", "Лестница");
addWord("dian4ti1", "transport", "电梯", "diàn tī", "Лифт");
...
addWord("ming2xin4pian4", "travelling", "明信片", "míng xìn piàn", "Открытка");
...
addWord("jia1na2da4", "countries", "加拿大", "jiā ná dà", "Канада");
...
addWord("pu2taoya2", "countries", "葡萄牙", "pú tao yá", "Португалия");
addWord("ba1xi1", "countries", "巴西", "bā xī", "Бразилия");
addWord("ou1zhou1", "countries", "欧洲", "ōu zhōu", "Европа");
addWord("bei3jing1", "countries", "北京", "běi jīng", "Пекин");
addWord("shang4hai3", "countries", "上海", "shàng hǎi", "Шанхай");
addWord("xiang1gang3", "countries", "香港", "xiāng gǎng", "Гонконг");
addWord("guang3zhou1", "countries", "广州", "guǎng zhōu", "Гуанчжоу");
addWord("guang3dong1", "countries", "广东", "guǎng dōng", "Гуандун");

addWord("shang1dian4", "shop", "商店", "shāng diàn", "Магазин");
addWord("chao1shi4", "shop", "超市", "chāo shì", "Супермаркет");
...
addWord("gui4", "shop", "贵", "guì", "Дорогой");
addWord("pian2yi", "shop", "便宜", "pián yi", "Дешёвый");

addWord("gong1zuo4", "work", "工作", "gōng zuò", "Работать");
addWord("dang1", "work", "当", "dāng", "Стать");
addWord("shang4ban1", "work", "上班", "shàng bān", "Идти на работу");
addWord("xia4ban1", "work", "下班", "xià bān", "Заканчивать работу");
addWord("jia1ban1", "work", "加班", "jiā bān", "Работать сверхурочно");
addWord("ci2zhi2", "work", "辞职", "cí zhí", ["Увольняться", "Уволиться"]);
addWord("zuo4zhe3", "work", "作者", "zuò zhě", "Автор");
addWord("yan3yuan2", "work", "演员", "yǎn yuán", "Актёр");
addWord("ge1shou3", "work", "歌手", "gē shǒu", "Певец");
addWord("lu4shi1", "work", "律师", "lǜ shī", "Адвокат");
...
addWord("wang3shang4", "work", "网上", "wǎng shàng", "Онлайн");
...
addWord("chang4", "hobby", "唱", "chàng", "Петь");
addWord("chang4ge1", "hobby", "唱歌", "chàng gē", ["Петь", "Петь песню"]);
addWord("hua4huar4", "hobby", "画画儿", "huà huàr", "Рисовать картину");
...
addWord("pao3", "sport", "跑", "pǎo", ["Бегать", "Бежать"]);
addWord("pao3bu4", "sport", "跑步", "pǎo bù", ["Бегать", "Бежать"]);
...
addWord("dui4_1", "sport", "队", "duì", "Команда");
...
addWord("ge4", "counting_words", "个", "gè", "Счётное слово");
...
addWord("dao4_1", "counting_words", "道", "dào", "Порция");
addWord("di4", "counting_words", "第", "dì", "Порядковый номер");
...
addWord("jin4_2", "location", "近", "jìn", "Близко");
addWord("yuan3", "location", "远", "yuǎn", "Далеко");
addWord("li2", "location", "离", "lí", ["От", "До"]);
addWord("cong2", "location", "从", "cóng", ["Из", "С", "До"]);
addWord("dao4_2", "location", "到", "dào", ["До", "Добираться", "Прибыть"]);
...
addWord("de_1", "summarize", "的", "de", "Притяжательная частица");
addWord("de_2", "summarize", "得", "de", "Оценочная частица");
addWord("dong3", "summarize", "懂", "dǒng", "Понимать");
addWord("wan2", "summarize", "完", "wán", "Закончить");
...
addWord("mei3", "summarize", "每", "měi", "Каждый");
...
addWord("zhong3", "summarize", "种", "zhǒng", ["Вид", "Тип"]);

addWord("zheng4zai4", "other", "正在", "zhèng zài", ["Быть в процессе", "Длиться"]);
addWord("guo4", "other", "过", "guò", ["Праздновать", "Показатель прошедшего времени"]);
addWord("le", "other", "了", "le", "Показатель изменения");
addWord("mei2", "other", "没", "méi", "Не");
addWord("bu4", "other", "不", "bù", "Не");
addWord("yin1wei2", "other", "因为", "yīn wéi", ["Так как", "Потому что"]);
addWord("suo3yi3", "other", "所以", "suǒ yǐ", ["Так что", "Поэтому"]);
addWord("ne", "other", "呢", "ne", "А");
addWord("dui4_2", "other", "对", "duì", ["Верно", "Для", "Влиять"]);
addWord("hao3xiang4", "other", "好像", "hǎo xiàng", "Кажется");
