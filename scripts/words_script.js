...
addWord("ju4zi", "school", "句子", "jù zi", "Предложение, фраза");
...
addWord("kai1xin1", "appearance", "开心", "kāi xīn", "Весёлый");
addWord("gao1xing4", "appearance", "高兴", "gāo xìng ", "Радостный");
addWord("kai1lang3", "appearance", "开朗", "kāi lǎng ", "Жизнерадостный");
...
addWord("hua4", "travelling", "画", "huà", "Картина");
...
addWord("pao3bu4", "hobby", "跑步", "pǎo bù", "Бегать");
